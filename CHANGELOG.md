...
- Allowed signed and notarized macOS builds to load allowlisted DuckDB
  extensions from the private cache while retaining hardened runtime and the
  existing DuckDB extension provenance controls.
